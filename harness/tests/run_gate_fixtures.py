...
def main():
    ...
    fixtures = []
    for fn in ("gate_fixtures.json", "gate_fixtures_r11.json", "gate_fixtures_r12.json", "gate_fixtures_r13.json", "gate_fixtures_r14.json", "gate_fixtures_r15.json", "gate_fixtures_r16.json", "gate_fixtures_conf.json"):
